...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 if (isset($_POST['user_fullname'], $_POST['email'], $_POST['password'])) {
  ...
  //USO DO CONTROLLER PARA VERIFICAÇÃO DE EMAIL E CADASTRO DO USUÁRIO 
  //verifica se já existe um email cadastrado
  // referencia a função criada em UserController
  ...
  $registerUserMessage = "Já existe um usuário cadastrado com esse endereço de e-mail";
    ...
    if ($userController->registerUser($user_fullname, $email, $password)) {
        //me mande para um outro local, sendo assim,
        //  a informação enviada para o back-end é o redirecionamento para o login.
        //  REDIRECIONAMENTO PARA OUTRA PÁGINA QUANDO O USÁRIO FOR CADASTRADO
